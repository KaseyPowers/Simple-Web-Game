import type { InputParserFn, UpdaterFnInput } from "~/game_logic/updater_types";
import { createUpdaterBuilder } from "~/game_logic/updater";
import type { GameRoomDataI, RoomOrId } from "./types";
import { getRoom, setRoom } from "./store_utils";
